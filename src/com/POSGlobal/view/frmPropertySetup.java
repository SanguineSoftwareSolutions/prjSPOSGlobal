...
//            }
    ...
    private void initComponents()
    {
        ...
        cmbBillFormatType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Text 1", "Text 2", "Text 3", "Text 4", "Text 5", "Text 6", "Text 7", "Text 8", "Text 9", "Text 10", "Text 11", "Text 12", "Text 13", "Text 14", "Text 15", "Text 16", "Text 17", "Text 18", "Text 19", "Text 20", "Text 21", "Text PlayZone", "Text Foreign", "Jasper 1", "Jasper 2", "Jasper 3", "Jasper 4", "Jasper 5", "Jasper 6", "Jasper 7", "Jasper 8", "Jasper 9", "Jasper 10", "Stationery 1", "Stationery 2", "Stock Transfer Note 1", "Saloon 1" }));
        ...
        panelPOSSetup4Layout.setVerticalGroup(
            ...
            .addGroup(panelPOSSetup4Layout.createSequentialGroup()
                ...
                .addGroup(panelPOSSetup4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelPOSSetup4Layout.createSequentialGroup()
                        .addComponent(cmbPOSToWebBooksPostingCurrency)
                        .addGap(1, 1, 1)))
                .addGap(37, 37, 37))
        );
		...
		else
		{
			...
			if (!selectedLikePOSCode.equals("NA"))
			{
				...
				sql = "insert into tblsetup(strClientCode,strClientName,strAddressLine1,strAddressLine2 "//4
					...
					+ ",strShowReportsInCurrency,strPOSToMMSPostingCurrency,strPOSToWebBooksPostingCurrency )"//225
					...
					+ ",'" + showReportsInCurrency + "','"+posToMMSPostingCurrency+"','"+posToWebBooksPostingCurrency+"')";//225
			    }
		...
		else
		{
			...
			while (rsLikePOS.next())
			{
			    ...
			    sql = "insert into tblsetup(strClientCode,strClientName,strAddressLine1,strAddressLine2 "//4
				    ...
				    + ",'" + rsLikePOS.getString(223) + "','" + rsLikePOS.getString(224) + "','" + rsLikePOS.getString(225) + "')";//225
			}
			...
			String sqlUpdate = "UPDATE tblsetup "
				...
				+ ",strShowReportsInCurrency=?,strPOSToMMSPostingCurrency=?,strPOSToWebBooksPostingCurrency=? "
			...
			objPstmt.setString(219, txtClientCode.getText());
			objPstmt.setString(220, newPropertyPOSCode);
